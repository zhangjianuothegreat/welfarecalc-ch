/**
 * Kanton Ticino (TI) Sozialhilfe-Algorithmus 2026
 * Rechtsgrundlage: Legge sull'assistenza sociale (LAS TI) + SKOS-Richtlinien 2026
 ...
 */
export default function calculateSozialhilfe_TI(inputs, cantonRules) {
