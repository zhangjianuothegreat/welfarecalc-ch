/**
 * Kanton Uri (UR) Sozialhilfe-Algorithmus 2026
 * Rechtsgrundlage: Sozialhilfegesetz UR (SHG UR) + SKOS-Richtlinien 2026
 ...
 */
export default function calculateSozialhilfe_UR(inputs, cantonRules) {
