/**
 * Kanton Luzern (LU) Sozialhilfe-Algorithmus 2026
 * Rechtsgrundlage: Sozialhilfegesetz LU (SHG LU) + SKOS-Richtlinien 2026
 ...
 */
export default function calculateSozialhilfe_LU(inputs, cantonRules) {
