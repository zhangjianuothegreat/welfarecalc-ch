/**
 * Kanton Obwalden (OW) Sozialhilfe-Algorithmus 2026
 * Rechtsgrundlage: Sozialhilfegesetz OW (SHG OW) + SKOS-Richtlinien 2026
 ...
 */
export default function calculateSozialhilfe_OW(inputs, cantonRules) {
