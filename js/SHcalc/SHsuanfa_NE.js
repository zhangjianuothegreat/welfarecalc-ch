/**
 * Kanton Neuenburg (NE) Sozialhilfe-Algorithmus 2026
 * Rechtsgrundlage: Loi sur l’action sociale (LASoc NE) + SKOS-Richtlinien 2026
 ...
 *
 * Hinweise:
 * - Mietzinslimiten sind kantonal einheitlich (keine Regionen, aber Gemeindeabhängigkeit möglich)
 ...
 */
export default function calculateSozialhilfe_NE(inputs, cantonRules) {
  ...
  /* --------------------------------------------------
   * 3. Wohnkosten (kantonal einheitlich)
   * -------------------------------------------------- */
