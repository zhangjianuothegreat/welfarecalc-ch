/**
 * Kanton Schwyz (SZ) Sozialhilfe-Algorithmus 2026
 * Rechtsgrundlage: Sozialhilfegesetz SZ + SKOS-Richtlinien 2026
 ...
 *
 * Hinweise:
 * - Mietzinslimiten sind kantonal einheitlich (Gemeindeabhängigkeit möglich)
 ...
 */
export default function calculateSozialhilfe_SZ(inputs, cantonRules) {
  ...
  /* --------------------------------------------------
   * 3. Wohnkosten (kantonal vereinheitlichte Richtwerte, Gemeinde kann abweichen)
   * -------------------------------------------------- */
