/**
 * Kanton Glarus (GL) Sozialhilfe-Algorithmus 2026
 * Rechtsgrundlagen: Sozialhilfegesetz GL (SHG GL) + SKOS-Richtlinien 2026
 ...
 *
 * Hinweise:
 * - Mietzinslimiten sind kantonal gemittelte Richtwerte (Gemeindeabhängigkeit möglich)
 ...
 */
export default function calculateSozialhilfe_GL(inputs, cantonRules) {
  ...
  /* --------------------------------------------------
   * 3. Wohnkosten (kantonale Richtwerte)
   * -------------------------------------------------- */
