/**
 * Kanton Nidwalden (NW) Sozialhilfe-Algorithmus 2026
 * Rechtsgrundlage: Sozialhilfegesetz NW (SHG NW) + SKOS-Richtlinien 2026
 ...
 */
export default function calculateSozialhilfe_NW(inputs, cantonRules) {
