// 修改后的完整 SHsuanfa_GE.js
/**
 * Kanton Genf (GE) – Sozialhilfe Berechnung 2026
 * Rechtsgrundlage: LASI GE / RELASI / SKOS-Richtlinien 2026
 ...
 */
export default function calculateSozialhilfe_GE(inputs, cantonRules) {
  const r = cantonRules?.sozialhilfe;
  if (!r || !r.grundbedarf_monthly) {
    return { error: 'err_missing_sh_rules', annualBenefit: 0 };
  }
  /* ===============================
   * 1. Haushalt & Vermögen (SKOS 2026 mit GE-Praxis)
   * ============================== */
  ...
  /* ===============================
   * 3. Miete (Genf: einheitliche urbane Referenzwerte, hohe Kostenlage)
   * ============================== */
  ...
  /* ===============================
   * 8. Vermögensverzehr (SKOS-Standard; kein GE-spezifischer langsameren Satz)
   * ============================== */
