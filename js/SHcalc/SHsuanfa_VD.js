/**
 * Kanton Waadt (VD) Sozialhilfe-Algorithmus 2026
 * Rechtsgrundlage: Loi sur l'action sociale (LAS VD) + SKOS-Richtlinien 2026
 ...
 */
export default function calculateSozialhilfe_VD(inputs, cantonRules) {
