/**
 * Kanton Schaffhausen (SH) Sozialhilfe-Algorithmus 2026
 * Rechtsgrundlage: Sozialhilfegesetz SH + SKOS-Richtlinien 2026
 ...
 */
export default function calculateSozialhilfe_SH(inputs, cantonRules) {
  ...
  /* --------------------------------------------------
   * 3. Wohnkosten (kantonal gemittelt)
   * -------------------------------------------------- */
